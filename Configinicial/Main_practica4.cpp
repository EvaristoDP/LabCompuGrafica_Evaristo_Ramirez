//Práctica 4. Proyecciones y transformaciones.
...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Practica 4. Modelado geometrico - Evaristo Ramirez del Prado", nullptr, nullptr);
	...
	float vertices[] = {
		...
		-0.5f, -0.5f,-0.5f,  /*---*/0.0f, 1.0f, 0.0f,//Cara:  Trasera
		...
		-0.5f, -0.5f, -0.5f, /*---*/0.0f, 1.0f, 1.0f,//Cara: Inferior.
		...
		-0.5f,  0.5f, -0.5f, /*---*/1.0f, 0.5f, 0.0f,//Cara: Superior
