...
//Fecha de entrega: 3 de marzo 2026
//------------------------------------------------------------------------
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 modelTemp3 = glm::mat4(1.0f); //Temp para dedo 2
		...
		//Dedo2
		model = glm::translate(modelTemp2, glm::vec3(0.25, 0.35f, -0.375f));
		...
		//Dedo2_1
		//model = glm::translate(modelTemp, glm::vec3());
